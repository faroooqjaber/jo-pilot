          ...
          <div className="space-y-5">
            ...
            {(mode === "login" || mode === "signup") && (
              <>
                ...
                {!agreed && (
                  <p className="text-destructive text-xs font-semibold text-center" dir="rtl">
                    يجب الموافقة على الشروط القانونية قبل تسجيل الدخول بأي وسيلة
                  </p>
                )}
                <div className="grid grid-cols-2 gap-3">
                  <Button variant="outline" className="h-11 gap-2 font-medium" onClick={() => handleOAuth("google")} disabled={loading || !agreed}>
                  ...
                  <Button variant="outline" className="h-11 gap-2 font-medium" onClick={() => handleOAuth("apple")} disabled={loading || !agreed}>
